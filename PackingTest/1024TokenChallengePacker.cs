...
using static PieceTableGenerator;

namespace PackingTest
{
    internal class _1024TokenChallengePacker : IPSTPacker
    {
        ...
        private decimal[] PackData(List<int[]> tablesToPack)
        {
        ...
        private int[][] UnpackData(decimal[] tablesToUnpack)
        {
        ...
        private void PrintUnpackedData(int[][] unpackedData)
        {
